...
<section class="section section-30 section-xxl-40 section-xxl-66 section-xxl-bottom-90 novi-background bg-gray-dark page-title-wrap" style="background-image: url({{ url('themes/web/images/bg-image-9.jpg') }});">
    <div class="container">
...
<section class="section novi-background how-we-operate">
    <div class="container">
            ...
            <div class="col-md-12 col-xl-12 text-secondary">
                <div class="timeline">
                    <ul>
                        ...
                        <li>
                            <div class="content">
                                <h3>Co-Source, Co-Train, Co-Manage</h3>
                                <div>
