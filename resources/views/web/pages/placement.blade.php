                ...
                <blockquote class="quote-bordered">
                    <div class="quote-body">
                        ...
                        <div class="quote-body-inner">
                            <h6>A Superb Product for The Price...</h6>
                            <p>
                                <q>I guess I’ll be a returning client. Your Live Chat service is awesome. It allows to settle any issue 24/7. Got really enjoyable experience with your product. Easy set up is a huge plus. I even didn’t turn to support service. A superb product for the price. </q>
                            </p>
                        </div>
                    </div>
                    <div class="quote-footer">
                        <div class="unit unit-horizontal unit-spacing-sm align-items-center">
                            <div class="unit-left"><img class="img-circle" src="themes/images/user.png" alt="" width="68" height="68"/>
                            </div>
                            <div class="unit-body">
            ...
            <div class="col-md-6">
                <blockquote class="quote-bordered">
                    <div class="quote-body">
                        ...
                        <div class="quote-body-inner">
                            <h6>Easy to Read Instructions are Really Helpful...</h6>
                            <p>
                                <q>Got really enjoyable experience with your product. Easy set up is a huge plus.I even didn’t turn to support service. Easy to read instructions are really helpful. Excellent, have nothing to add. Your Live Chat service is awesome. It allows to settle any issue 24/7.</q>
                            </p>
                        </div>
                    </div>
                    <div class="quote-footer">
